      ...
      <div class="container">
        ...
        <div class="page-content text-center">
          ...
          <div class="page-title">
            ...
            <!-- box title -->
            <a href="#">৩.৫.২ NAND গেইট ব্যবহার করে বিশেষ গেইট তৈরী</a>
          </div>
          <!-- box body -->
          <div class="page-body">
            <div class="topic-parts-imp">
              <p>কোনো ফাংশনকে NAND গেইট এর উপযুক্ত করতে দুইবার NOT করতে হয় এবং ভিতরের NOT এর কাজ করতে হয়। </p>
            ...
            <div class="topic-parts">
              <p class="question text-light-primary">NAND gate দিয়ে XOR gate</p><hr>
              <hr>
              ...
              <p><b>ধাপ সমূহ</b></p>
              <img class="col-sm-12 col-md-10 responsive" src="{{ asset('assets') }}/images/chapter/chap3/3.5.2/lg1.png" alt="">
              <br><br>
              <p>উপরের সরলকৃত ফাংশন NAND গেইট দিয়ে তৈরির উপযুক্ত। কারন, লক্ষ করলে দেখা যাবে ফাংশনটিতে NAND গেইটের সাধারন ফাংশন <span>A . B</span> আছে শুধু।</p>
              <p>উপরের ফাংশনটির লজিক চিত্র নিচে দেয়া হলঃ</p>
              <video width="320" height="240" controls><source src="{{ asset('assets') }}/images/chapter/chap3/vdo/vdo16.MP4" type="video/mp4"></video>
            </div>

            <div class="topic-parts">
              <p class="question text-light-primary">NAND gate দিয়ে XNOR gate</p><hr>
              <hr>
              <p>XNOR গেইটের সাধারন লজিক ফাংশন হলঃ</p>
              <p style="text-align:center;">F = <span>A ⊕ B</span> <br>= <span>A</span> . <span>B</span> + A . B</p>
              <p>উপরের ফাংশনটিকে দুইবার NOT করে সরল করা হল নিচে:</p>
              <p><b>ধাপ সমূহ</b></p>
              <img class="col-sm-12 col-md-10 responsive" src="{{ asset('assets') }}/images/chapter/chap3/3.5.2/lg2.png" alt="">
              <br><br>
              <p>উপরের সরলকৃত ফাংশন NAND গেইট দিয়ে তৈরির উপযুক্ত। কারন, লক্ষ করলে দেখা যাবে ফাংশনটিতে NOR গেইটের সাধারন ফাংশন <span>A . B</span> আছে শুধু।</p>
              <p>উপরের ফাংশনটির লজিক চিত্র নিচে দেয়া হলঃ</p>
              <video width="320" height="240" controls><source src="{{ asset('assets') }}/images/chapter/chap3/vdo/vdo17.MP4" type="video/mp4"></video>
            </div>
