        ...
        <div class="page-content text-center">
          ...
          <div class="page-body">
              <div class="topic-parts">
                  <p class="question text-light-primary">লুপ! লুপ! লুপ!</p>
                  <p class="">প্রোগ্রামিং এ এককাজ আমাদের বার বার করতে হতে পারে। সি প্রোগ্রামিং এ লুপ ব্যবহার করে একি কাজ বার বার করা! অনেক বড় বড় প্রোগ্রাম লুপ এর মাধ্যমে খুব সহজেই করা যায়! সি ভাষায় ৩ ধরনের লুপ আছে।</p>
                  <ol>
                    <li>for লুপ</li>
                    <li>while লুপ</li>
                    <li>do while লুপ</li>
